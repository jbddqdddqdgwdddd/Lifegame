...
public class AngleColorModel extends ColorModel {
    ...
    private Color getColor(Creature o, float h, float s, float br) {
        Creature[] ancestors = new Creature[4];
        Creature a = o;
    ...
    private double getDotProduct(Creature o, Creature p, Creature g) {
        double dx1 = o.x-p.x;
        double dy1 = o.y-p.y;
        double dx2 = p.x-g.x;
        double dy2 = p.y-g.y;
    ...
    private Color getRandomColor(Creature o) {
